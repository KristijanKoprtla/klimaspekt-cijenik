...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen">
      <h1 className="text-center mt-11 mb-4 text-3xl font-bold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-500 from-red-700">KLIMASPEKT</span></h1>
      ...
      >
        {showBag
          ? "Prebaci na vrećasti filter"
          : "Prebaci na kazetni filter"}
      </button>
      {showBag ? <FramedFilterForm /> : <BagFilterForm />}


      <p className="p-5 text-gray-400 bg-white text-center font-light">
